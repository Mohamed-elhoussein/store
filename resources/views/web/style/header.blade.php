...
<img src="{{asset('web/images/logo/logo.svg')}}">
</a>
...
<input type="text" placeholder="Search" class="_search">
</div>
...
<i class="lni lni-cart"></i>
 <span class="total-items">{{ $num_pro??=0 }}</span>
</a>

<div class="shopping-item">
<div class="dropdown-cart-header">
<span class="Items_pro">{{ $num_pro??=0 }} Items</span>
<a href="cart.html">View Cart</a>
</div>
<ul class="shopping-list">
<?php $total=0?>
@auth
    @forelse ($data_cart as $data_cart)

<li class="item_pro">
<a href="javascript:void(0)" class="remove del_pro" del_pro="{{ $data_cart['products'][0]['id'] }}" title="Remove this item"><i class="lni lni-close"></i></a>
<div class="cart-img-head">
<a class="cart-img" href="product-details.html">
<img src="{{ asset('storage/images/'.$data_cart['products'][0]['images'][0]['image']) }}">
</a>
</div>
<div class="content">
<h4><a href="product-details.html">
{{ $data_cart["products"][0]["name"] }}</a></h4>
<p class="quantity"> <span class="count_pro">{{ $data_cart->count }}</span> x -$<span class="amount price_pro">{{$data_cart["products"][0]["price"] }}</span></p>
</div>
</li>
<?php $total+=$data_cart["count"]*$data_cart["products"][0]["price"]  ?>
@empty
...
<div class="list-group  all_search"></div>
...
<li class="nav-item"><a href="{{ route('web/login') }}">Login</a></li>
