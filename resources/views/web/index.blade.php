...
<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">4</span>  of 2</div>
<div id="tns1-mw" class="tns-ovh">
<div class="tns-inner" id="tns1-iw">
<div class="hero-slider  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" id="tns1" style="transform: translate3d(-50%, 0px, 0px); transition-duration: 0s;"><div class="single-slider tns-item tns-slide-cloned" style="background-image: url({{asset('web/images/hero/slider-bg1.jpg')}});" aria-hidden="true" tabindex="-1">
<div class="content">
...
<div class="single-slider tns-item tns-slide-cloned" style="background-image: url({{asset ('web/images/hero/slider-bg2.jpg')}}') }});" aria-hidden="true" tabindex="-1">
<div class="content">
...
<div class="single-slider tns-item" style="background-image: url({{asset('web/images/hero/slider-bg1.jpg')}});" id="tns1-item0" aria-hidden="true" tabindex="-1">
<div class="content">
<h2><span>No restocking fee ($35 savings)</span>
M75 Sport Watch
</h2>
...
<div class="single-slider tns-item tns-slide-active" style="background-image: url({{asset('web/images/hero/slider-bg2.jpg')}});" id="tns1-item1">
<div class="content">
<h2><span>Big Sale Offer</span>
Get the Best Deal on CCTV Camera
</h2>
...
<div class="single-slider tns-item tns-slide-cloned" style="background-image: url({{asset('web/images/hero/slider-bg1.jpg')}});" aria-hidden="true" tabindex="-1">
<div class="content">
<h2><span>No restocking fee ($35 savings)</span>
M75 Sport Watch
</h2>
...
</div><div class="single-slider tns-item tns-slide-cloned" style="background-image: url({{asset('web/images/hero/slider-bg2.jpg')}});" aria-hidden="true" tabindex="-1">
<div class="content">
<h2><span>Big Sale Offer</span>
Get the Best Deal on CCTV Camera
</h2>
...
<img style=" height:400px;"  src="{{asset('storage/images/'.$val->images[0]['image'])}}" alt="#">
<div class="button">

@if (Auth::guard('web')->check())
<bottom  class="btn add_cart" id_product="{{ $val->id }}">
<i class="lni lni-cart" ></i> Add to Cart</bottom>
@else
<a  class="btn add_cart" href="{{ route('web/register') }}"><i class="lni lni-cart" ></i> Add to Cart</a>
...
<span class="category">{{ $val->cteogry }}</span>
<h4 class="title">
<a href="product-grids.html">{{ $val->name }}</a>
</h4>
<ul class="review">
...
<div class="single-banner right" style="background-image:url('{{asset('web/images/banner/banner-3-bg.jpg')}}');margin-top: 30px;">
<div class="content">
...
<div class="box">
<h1 id="minutes">0-52</h1>
<h2 id="minutestxt">Minutes</h2>
</div>
<div class="box">
<h1 id="seconds">0-28</h1>
<h2 id="secondstxt">Secondes</h2>
</div>
</div>
<div style="background: rgb(204, 24, 24); display: block;" class="alert">
...
<div class="tns-outer" id="tns2-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">23 to 27</span>  of 8</div><div id="tns2-mw" class="tns-ovh"><div class="tns-inner" id="tns2-iw"><div class="brands-logo-carousel d-flex align-items-center justify-content-between  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" id="tns2" style="transform: translate3d(-73.3333%, 0px, 0px);"><div class="brand-logo tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
<img src="{{asset('web/images/brands/06.png')}}" alt="#">
</div><div class="brand-logo tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
